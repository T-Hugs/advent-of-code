...
async function p2015day10_part1(input) {
    return "Not implemented";
}
async function p2015day10_part2(input, part1Solution) {
    return "Not implemented";
}
async function run() {
    const input = await util.getInput(DAY, YEAR);
    const part1Solution = String(await p2015day10_part1(input));
    const part2Solution = String(await p2015day10_part2(input, part1Solution));
